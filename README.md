...
## Data lake S3 : [s3://project-final-citi-bike/hourly_counts_all_stations.parquet](https://project-final-citi-bike.s3.us-east-1.amazonaws.com/hourly_counts_all_stations.parquet)
